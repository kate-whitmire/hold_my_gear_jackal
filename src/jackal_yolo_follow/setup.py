...
setup(
    ...
    zip_safe=True,
    maintainer='robot',
    maintainer_email='katewhitmire21@gmail.com',
    ...
    entry_points={
        'console_scripts': [
            'circle_drive = jackal_yolo_follow.circle_drive:main',
            'follow_mode_gui_backup = jackal_yolo_follow.follow_mode_gui_backup:main',            
